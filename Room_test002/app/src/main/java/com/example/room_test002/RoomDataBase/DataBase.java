...
@Database(entities = {com.jetec.roomdatabaseexample.RoomDataBase.MyData.class},version = 2,exportSchema = true)
...
//        }
    ...
    public abstract com.jetec.roomdatabaseexample.RoomDataBase.DataUao getDataUao();//設置對外接口
}
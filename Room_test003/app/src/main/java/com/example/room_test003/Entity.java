...
@androidx.room.Entity(tableName = "MyTable01")  //這邊要先取好table的名字，稍後的table設置必須與他相同
...
public class Entity {
    ...
    public Entity(String name, String Age, String Hobby, String Email) {
        this.name = name;
        this.Age = Age;
        this.Hobby = Hobby;
        this.Email = Email;
    ...
    public Entity(int id, String name, String Age, String Hobby, String Email) {
        this.id = id;
        this.name = name;
        this.Age = Age;
        this.Hobby = Hobby;
